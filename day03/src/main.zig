...
pub fn main() !void {
    ...
    const answer1 = try day03.solution(input, .partOne);
    const answer2 = try day03.solution(input, .partTwo);
...
test "part1" {
    ...
    try testing.expectEqual(357, day03.solution(input, .partOne));
}
...
test "part2" {
    ...
    try testing.expectEqual(3121910778619, day03.solution(input, .partTwo));
}
